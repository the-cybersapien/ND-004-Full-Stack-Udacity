...
quote1 = Quote(title="The Question",
...
quote2 = Quote(title="Mad Man with a Box!",
...
quote3 = Quote(title="Everybody Dies",
...
quote4 = Quote(title="Interogation",
